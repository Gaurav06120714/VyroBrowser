...
|---|---|---|
| **macOS** (Apple Silicon M1/M2/M3/M4) | [Vyro-macOS-AppleSilicon-v2.4.0.dmg](https://github.com/Gaurav06120714/VyroBrowser/releases/download/v2.4.0/Vyro-macOS-AppleSilicon-v2.4.0.dmg) | Drag to Applications |
| **macOS** (Intel) | [Vyro-macOS-Intel-v2.4.0.dmg](https://github.com/Gaurav06120714/VyroBrowser/releases/download/v2.4.0/Vyro-macOS-Intel-v2.4.0.dmg) | Drag to Applications |
| **Windows** x64 | [Vyro-Setup-Windows-x64-v2.4.0.exe](https://github.com/Gaurav06120714/VyroBrowser/releases/download/v2.4.0/Vyro-Setup-Windows-x64-v2.4.0.exe) | Run installer |
| **Linux** x64 | [Vyro-Linux-v2.4.0-x86_64.AppImage](https://github.com/Gaurav06120714/VyroBrowser/releases/download/v2.4.0/Vyro-Linux-v2.4.0-x86_64.AppImage) | `chmod +x` then run |
...
- [x] Fixed Ollama chat streaming (buffered NDJSON, error surfacing)
- [x] AI settings: connection status, Test button, installed-model dropdown
- [x] Right-sized macOS app icon (native-style transparent padding)
