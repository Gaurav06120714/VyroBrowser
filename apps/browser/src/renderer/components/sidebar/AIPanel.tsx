    ...
    <div className="flex flex-col h-full">
      ...
      <div className="p-3 border-t border-white/[0.08] shrink-0">
        <textarea
          ...
          rows={3}
          className="w-full bg-white/5 border border-white/10 rounded-xl px-3 py-2 text-sm text-white/90 placeholder:text-white/25 focus:outline-none focus:border-vyro-500/40 resize-none transition-colors"
        />
